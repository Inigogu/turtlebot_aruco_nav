...
"""autogenerated by genpy from turtlebot3_msgs/GoToPoseActionResult.msg. Do not edit."""
import codecs
import sys
...
class GoToPoseActionResult(genpy.Message):
  ...
  _type = "turtlebot3_msgs/GoToPoseActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','turtlebot3_msgs/GoToPoseResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = turtlebot3_msgs.msg.GoToPoseResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = turtlebot3_msgs.msg.GoToPoseResult()
